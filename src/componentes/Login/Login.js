...
function Login2() {
    ...
    return (
        <div>
          <a href="/"><img
            className="h-8 mx-auto mt-2 mb-2"
          ...
          /></a>
                <section className="relative flex flex-wrap lg:h-screen lg:items-center">
                  <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
                    ...
                    <form action className="mx-auto mb-0 mt-8 max-w-md space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button type="submit" className="inline-block rounded-lg bg-green-700 px-5 py-3 text-sm font-medium text-white">
                          Sign in
                        </button>
                      </div>
                    </form>
                  ...
                  <div className="relative h-64 w-full sm:h-96 lg:h-full lg:w-1/2">
                    <img alt="Welcome" src="https://images.unsplash.com/photo-1604014237800-1c9102c219da?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80" />
                  </div>
                </section>
                </div>
              );
